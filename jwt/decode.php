...
$recievedJwt = 'eyJhbGciOiAiSFMyNTYiLCJ0eXAiOiAiSldUIn0=.eyJuYW1lIjogIk9jdGF2aWEgQW5naGVsIiwiZW1haWwiOiAib2N0YXZpYWFuZ2hlbEBnbWFpbC5jb20ifQ==.UIylsWJneHhTQFWMQSwXGO6JltxASYU9eV2I4mP1UMI=';
...
$resultedsignature = base64_encode(hash_hmac('sha3-256', $recievedHeaderAndPayload, $secret_key, true));
...
if($resultedsignature == $recieved_signature) {
  // If everything worked fine, if the signature is ok and the payload was not modified you should get a success message
	echo "Success<br>";
	print(base64_decode($jwt_values[1]));
	print(base64_decode($jwt_values[0]));
}
?>